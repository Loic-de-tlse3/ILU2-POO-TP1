...
public class Etal {
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) throws IllegalArgumentException, IllegalStateException{
		if (quantiteAcheter <= 0){
			throw new IllegalArgumentException("La quantité " + quantiteAcheter + " n'est pas supérieur ou égal à 1");
		}
		if (this.vendeur == null){
			throw new IllegalStateException("On ne peut pas acheter à un étal vide");
		}
		StringBuilder chaine = new StringBuilder();
		try{
